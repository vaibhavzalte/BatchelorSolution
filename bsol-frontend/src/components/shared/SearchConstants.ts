...
export const CATEGORIES = [
  ...
  { id: "vacancies", label: "Vacancies", icon: UserRound, color: "bg-emerald-500", border: "border-emerald-100", light: "bg-emerald-50", hex: "#ecfdf5", text: "text-emerald-600" },
  ...
  { id: "study-rooms", label: "Study Rooms", icon: Library, color: "bg-cyan-500", border: "border-cyan-100", light: "bg-cyan-50", hex: "#ecfeff", text: "text-cyan-600" },
];
